...
public class Revista extends Ejemplar {
    ...
    public Revista(Integer idEjemplar,String codigoEjemplar, String titulo, String autor, String ubicacion,
                   Estado estado, LocalDate fechaPublicacion, String tipoRevista) {
        super(idEjemplar,  codigoEjemplar,titulo, autor, ubicacion, TipoDocumento.Revistas, estado);
